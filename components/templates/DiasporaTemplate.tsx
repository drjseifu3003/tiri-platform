  ...
  return (
    <>
      <style>{`
        ...
        /* hero */
        .ds-hero{position:relative;height:65vh;min-height:400px;}
        .ds-hero img{width:100%;height:100%;object-fit:cover;display:block;}
        .ds-ov{position:absolute;inset:0;background:linear-gradient(180deg,rgba(28,28,30,.08) 0%,rgba(28,28,30,.38) 60%,${CHAR} 100%);}
